...
def main():
    ...
    # Extract study IDs from validation split of cropped dataset
    ...
    # Get studies from validation split
    val_studies = sorted(list(extract_study_ids_from_dir(val_images_dir)))
