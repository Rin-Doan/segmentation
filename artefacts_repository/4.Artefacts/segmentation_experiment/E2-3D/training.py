...
# Create datasets
train_dataset = Medical3DSegmentationDataset(train_studies, TRAINING_PATH, SEGMENTATION_PATH, augment=AUGMENT, augment_p=0.8)
val_dataset = Medical3DSegmentationDataset(val_studies, TRAINING_PATH, SEGMENTATION_PATH, augment=False, augment_p=0.8)
