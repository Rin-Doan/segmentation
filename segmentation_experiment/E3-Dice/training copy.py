...
LEARNING_RATE = 0.001
NUM_CLASSES = 9
NUM_WORKERS = 4  # Reduced from 8 to prevent OOM (each worker loads data in memory)
...
for epoch in range(EPOCHS):
    ...
    check_epochs = min(3, len(val_losses))
    recent_val_losses = val_losses[-check_epochs:]
