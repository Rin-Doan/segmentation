...
# Part 3: Data paths and training parameters
...
print(f"Cropped dataset directory: {CROPPED_DATASET_DIR}")
...
# Create datasets using cropped data
print("\nLoading datasets from cropped_yolo_dataset...")
train_dataset = CroppedSegmentationDataset(
    split='train',
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Training and Validation Loss Over Time (Cropped Dataset)')
plt.legend()
plt.grid(True)
